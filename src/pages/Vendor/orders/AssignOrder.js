...
const AssignOrders = (props) => {
  ...
  useEffect(() => {
    ...
    response.then((data) => {
      setData(data.result)
      const riders = postJSON("/functions/getAllRidersDetails", {laundryId : currentUser.objectId});
  ...
  return (
    <div>
      <Container>
        <Box component="div" className='whiteBg' sx={{boxShadow: 2, p:2, mx:3, position: 'relative', minHeight:320 }}>
