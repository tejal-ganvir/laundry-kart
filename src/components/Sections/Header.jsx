...
export default function Header() {
  return (
    <Wrapper id="home" className="container flexSpaceCenter">
      ...
      <RightSide>
        <ImageWrapper>
          <Img className="radius8" src={HeaderImage} alt="office" height={600} width={400} style={{zIndex: 9, objectFit:'cover'}} />
          <QuoteWrapper className="flexCenter darkBg radius8">
            ...
            <div>
              <p className="font15 whiteColor">
                <em>“The key is in not spending time, but in investing it.”</em>
              </p>
              <p className="font13 orangeColor textRight" style={{marginTop: '10px'}}>Stephen Covey</p>
            </div>
          </QuoteWrapper>
          <DotsWrapper>
            <Dots />
